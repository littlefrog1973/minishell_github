...
#    Updated: 2023/09/29 14:55:26 by sdeeyien         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = minishell.c get_token.c cd.c utils.c utils2.c export.c unset.c execute.c parsing.c parsing_util.c parsing_util2.c
